...
public class ValidationErrorHandler {
    ...
    public ResponseEntity<CustomApiError> handleNotFound(NotFoundException ex) {
    ...
    public ResponseEntity<CustomApiError> handleBadRequest(IllegalArgumentException ex) {
